...
void main (){
  ...
  auxTimeMs = gRandInRange( tSampleMs ) + tSampleMs/2;

  while(1){
    if (auxTimeMs > minTime) {
            P1OUT |= 0x01;                           // 0000|0001 = 0x01 pone en 1 P1.0 
            P1OUT &= ~0x01;                          // 1111|1110 = 0xFE pone en 0 P1.0 
